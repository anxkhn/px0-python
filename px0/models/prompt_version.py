...
class PromptVersion(BaseModel):
    ...
    PromptVersion
    """ # noqa: E501
    id: StrictStr = Field(description="Unique version identifier.")
    prompt_id: StrictStr = Field(description="Reference to parent Prompt ID.")
    version: StrictInt = Field(description="Incrementing sequence number of the version.")
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['draft', 'stable', 'live', 'archived']):
            raise ValueError("must be one of enum values ('draft', 'stable', 'live', 'archived')")
        return value
