...
class Login200Response(BaseModel):
    ...
    Login200Response
    """ # noqa: E501
    token: StrictStr = Field(description="The access token to be used in standard Bearer authentication.")
    expires_at: datetime = Field(description="The timestamp when this access token expires.")
    user: User
    __properties: ClassVar[List[str]] = ["token", "expires_at", "user"]
