...
class ListUserOrgs200Response(BaseModel):
    """
    ListUserOrgs200Response
    """ # noqa: E501
    organizations: Optional[List[OrganizationWithRole]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "organizations": [OrganizationWithRole.from_dict(_item) for _item in obj["organizations"]] if obj.get("organizations") is not None else None
        })
        return _obj
