...
class GetAdminInbox200Response(BaseModel):
    """
    GetAdminInbox200Response
    """ # noqa: E501
    inbox: Optional[List[InboxItem]] = None
    __properties: ClassVar[List[str]] = ["inbox"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in inbox (list)
        _items = []
        if self.inbox:
            for _item_inbox in self.inbox:
                if _item_inbox:
                    _items.append(_item_inbox.to_dict())
            _dict['inbox'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inbox": [InboxItem.from_dict(_item) for _item in obj["inbox"]] if obj.get("inbox") is not None else None
        })
        return _obj
