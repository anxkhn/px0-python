...
class DiffVersions200Response(BaseModel):
    """
    DiffVersions200Response
    """ # noqa: E501
    from_version: StrictInt
    to_version: StrictInt
    from_template: StrictStr
    to_template: StrictStr
    diff: StrictStr
    __properties: ClassVar[List[str]] = ["from_version", "to_version", "from_template", "to_template", "diff"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "to_template": obj.get("to_template"),
            "diff": obj.get("diff")
        })
        return _obj
