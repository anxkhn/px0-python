...
class ListOrgPeople200Response(BaseModel):
    """
    ...
    limit: StrictInt
    total: StrictInt
    __properties: ClassVar[List[str]] = ["people", "page", "limit", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "people": [User.from_dict(_item) for _item in obj["people"]] if obj.get("people") is not None else None,
            "page": obj.get("page"),
            "limit": obj.get("limit"),
            "total": obj.get("total")
        })
