...
class SetVersionTagRequest(BaseModel):
    """
    SetVersionTagRequest
    """ # noqa: E501
    tag: Annotated[str, Field(strict=True, max_length=50)] = Field(description="Tag string (alphanumeric, dots, dashes, underscores).")
